...
/* Toda la app es index.html: no queda un solo JavaScript externo desde que las
   figuras dejaron de ser un motor 3D (v32). Aqui solo estan el documento, el
   manifest y los iconos. */
